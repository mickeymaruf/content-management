    ...
    return (
        <>
            ...
            <div className={`md:hidden backdrop-blur-lg py-10 ${toggle ? 'right-0' : '-right-20'} top-0 fixed h-screen duration-500 flex flex-col justify-center z-50 border-l border-slate-900`}>
                <div className='px-3 absolute top-0 left-1/2 -translate-x-1/2 pt-8' onClick={() => setToggle(!toggle)}>
                    <HiOutlineXMark className='h-8 w-8' />
                </div>
                <ul className='px-3 flex flex-col items-center gap-6 text-center'>
                    <li className='w-full bg-slate-700 text-xs font-medium p-1 -rotate-45'><a href="#home">Home</a></li>
                    <li className='w-full bg-slate-700 text-xs font-medium p-1 -rotate-45'><a href="#projects">Projects</a></li>
                    <li className='w-full bg-slate-700 text-xs font-medium p-1 -rotate-45'><a href="#about">About</a></li>
                    <li className='w-full bg-slate-700 text-xs font-medium p-1 -rotate-45'><a href="#skills">Skills</a></li>
                    <li className='w-full bg-slate-700 text-xs font-medium p-1 -rotate-45'><a href="/blog">Blogs</a></li>
                    <li className='w-full bg-slate-700 text-xs font-medium p-1 -rotate-45'><a href="#contact">Contact</a></li>
                    <li><a target="_blank" href="https://github.com/mickeymaruf"><AiFillGithub className='h-8 w-8' /></a></li>
                    <li><a target="_blank" href="https://www.linkedin.com/in/mickeymaruf/"><AiFillLinkedin className='h-8 w-8' /></a></li>
                    <li><a target="_blank" href="https://www.facebook.com/mickeymaruf"><AiFillFacebook className='h-8 w-8' /></a></li>
                </ul>
